...
FetchWebDev() {
  curl -L https://codeload.github.com/wddx1688/web-dist/tar.gz/refs/heads/dev -o web-dist-dev.tar.gz
...
FetchWebRelease() {
  curl -L https://github.com/wddx1688/alist-web/releases/latest/download/dist.tar.gz -o dist.tar.gz
